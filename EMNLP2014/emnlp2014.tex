...
Of course, learning synchronous grammars from parallel data is a widely studied problem \cite[\emph{inter alia}]{Wu1997,Blunsom2008,Levenberg2012}. However, there has been less exploration of the learning rich nonterminal categories, largely because efforts to learn non-terminal categories have been coupled with efforts to learn derivation structures---a computationally formidable challenge.  One popular approach has been to derive categories from source and/or target monolingual grammars \cite{Galley2004,Zollmann2006,Hanneman2013}. However, while often successful, accurate parsers are not available in many languages: a more appealing approach is therefore to learn the category structure from the data itself.
