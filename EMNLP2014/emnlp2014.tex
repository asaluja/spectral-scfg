...
In this work, we refine the one-category grammar introduced by \newcite{Chiang2007} for hierarchical phrase-based translation (HPBT) in order to incorporate additional translational context via refined non-terminal (NT) categories instead of longer translation rules.  
